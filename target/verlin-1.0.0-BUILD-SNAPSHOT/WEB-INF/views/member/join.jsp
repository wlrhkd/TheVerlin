...
<div class="d-flex align-items-center flex-column">
    <form method="post" name="formMemberJoin">
        <div class="default-wrap-size mb-2">
            <%-- 헤더 공백처리     --%>
            <div class="header-empty-space"></div>
            <div>
                <h4 class="h4 mb-3">JOIN US</h4>
                <table class="table table-bordered address-table" >
                    <tr>
                        <td>아이디</td>
                        <td>
                            <input type="text" id="id" name="id" class="input-width-m">
                            <input type="button" value="중복확인" id="btnIdCheck" class="bg-white">
                        </td>
                    </tr>
                    <tr>
                        <td>비밀번호</td>
                        <td><input type="password" name="pw" class="input-width-m"></td>
                    </tr>
                    <tr>
                        <td>비밀번호 확인</td>
                        <td><input type="password" name="pw_r" class="input-width-m"></td>
                    </tr>
                    <tr>
                        <td>이름</td>
                        <td>
                            <input type="text" name="name" class="input-width-m">
                        </td>
                    </tr>
                    <tr>
                        <td>주소</td>
                    ...
                    <tr>
                        <td class="join-mPhone-td-width">휴대전화<i class="color-red">*</i></td>
                        <td>
            ...
            <table class="table table-bordered join-table">
                <tr>
                    <td class="align-middle">
                        <p class="join-p-title">
                            <span class="font-size-l">
                                이용약관 및 개인정보수집 및 이용, 쇼핑정보 수신(선택)에 모두 동의합니다.
                            </span>
                            <label>
                                <input type="checkbox" id="toggle" class="join-table-check">
                            </label>
                        </p>
                    </td>
                </tr>
                <tr>
                    <td class="d-flex flex-column">
                        <p>[필수] 이용약관 동의</p>
                        <label>
                            <textarea class="join-textarea-agree" readonly>
제1조(목적)
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다. 부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.
                        ...
                        <div>
                            <span class="font-size-m">이용약관에 동의하십니까?</span>
                            <label>
                                <input type="checkbox" class="join-table-check" id="required_sign1">
                            </label>
                            <span class="font-size-m">동의함</span>
                        </div>
                    </td>
                </tr>
                <tr>
...
o부정거래 방지 및 쇼핑몰 운영방침에 따른 보관 : OO년
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.
                        ...
                        <div>
                            <span class="font-size-m">개인정보 수집 및 이용에 동의하십니까?</span>
                            <label>
                                <input type="checkbox" class="join-table-check" id="required_sign2">
                            </label>
                            <span class="font-size-m">동의함</span>
                        </div>
                    </td>
...
선택 약관에 동의하지 않으셔도 회원가입은 가능하며, 회원가입 후 회원정보수정 페이지에서 언제든지 수신여부를 변경하실 수 있습니다.
                        ...
                        <div>
                            <span class="font-size-m">이메일 수신에 동의하십니까?</span>
                            <label>
                            	<input type="checkbox" class="join-table-check" id="email_receive_check">
                                <input type="hidden" name="email_receive_check">                           
                            </label>
                            <span class="font-size-m">동의함</span>
                        </div>
                    </td>
        ...
        <div class="default-wrap-size mb-5 d-flex justify-content-center">
            <div>
                <input class="join-btn-cancel" type="button" value="회원가입취소" id="btnCancel">
                <input class="join-btn-join" type="submit" value="회원가입">
            </div>
        </div>
    </form>
</div>
<script>
    document.onsubmit = function (event){
        const form = document.formMemberJoin
        if(form.id.value ===''){
            alert('아이디를 입력해주세요')
        ...
        if(!document.getElementById('required_sign1').checked){
            alert('필수 이용약관에 동의해주세요.')
            document.getElementById('email').scrollIntoView(true)
            return false
        }
        if(!document.getElementById('required_sign2').checked){
            alert('개인정보 수집 및 이용 약관에 동의해주세요.')
            document.getElementById('email').scrollIntoView(true)
            return false
        }

        if(document.getElementById('email_receive_check').checked === true)
            document.querySelector("input[name='email_receive_check']").value = true
        else
            document.querySelector("input[name='email_receive_check']").value = false
...
<script>
    ...
    function btnJoinCancel(){
        location.href = '${cpath}/'
    }
</script>
<script>
    window.onload = function (){
        document.getElementById('btnCancel').onclick = btnJoinCancel
        document.getElementById('btnIdCheck').onclick = function (){
