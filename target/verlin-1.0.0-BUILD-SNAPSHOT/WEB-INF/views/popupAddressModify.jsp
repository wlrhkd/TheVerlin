...
<div class="register_box">
	<form id="parForm" method="POST">
	<input type="hidden" name="address_index" value="${list[2].address_index }">
        <div class="register_wrap">
            <div class="register_delivery">배송지명</div>
            <input type="hidden" name="member_uid" value="2">
            <div class="register_delivery_input"><input name="address_name" value="${list[2].address_name }"></div>
        </div>
        <div class="register_wrap_a">
            <div class="register_name">성명</div>
            <div class="register_name_input"><input name="address_recipient" value="${list[2].address_recipient }"></div>
        </div>
        <div class="register_wrap_b">
            <div class="register_address">주소</div>
            <div class="register_address_input">
                <p>
                    <input class="modify_text" type="text" name="address_post" id="sample6_postcode" value="${list[2].address_post }" placeholder="우편번호">
                    <input class="modify_text find_post_btn" type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기">
                </p>
                <p>
                    <input class="modify_text basic_post" type="text" name="address_info" id="sample6_address" value="${list[2].address_info }" placeholder="주소">
                </p>
                <p>
                    <input class="modify_text detail_post" type="text" name="address_detail" id="sample6_detailAddress" value="${list[2].address_detail }" placeholder="상세주소">
<!--                     <input class="modify_text" type="text" name="postExtra"id="sample6_extraAddress" placeholder="참고항목"> -->
        ...
        <div class="register_wrap_c">
            ...
            <div class="register_phone_input">
                <p>
                    ...
                    -<input name="address_mphone" value="${list[2].address_mphone }">-
                    <input>
                </p>
            </div>
        </div>
        ...
        <div class="register_button">
            ...
            <p>
                <a href="popupAddress"><input type="button" id="register_btn1" value="수정" onclick="parSubmit(event)"></a>
...
<script>
	...
	function parSubmit(event) {
		...
		form.method = 'POST'
		form.action = '${cpath}/popupAddressModify'
		form.submit()
	}
